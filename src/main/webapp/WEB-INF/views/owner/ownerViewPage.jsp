    ...
    <form action="ownerUpdate.do" method='post' enctype="multipart/form-data"> 
        ...
        <div class="body_container"> <!-- 페이지 컨테이너 시작-->
            ...
            <div class="body_container_center"> <!-- 중간 메뉴바 시작-->
                <div class="title_font">업체 등록 / 수정</div>
                    ...
                    <img width="50%" height="50%" src="/project1982/resources/upload/${shopList[0].si_realname }">
                        ...
                        <div class= "body_container_center_shop_contanier_info">
                            <div class="store_name_box">업체 이름: ${shopList[0].shopname }</div>                                
                            <div class="store_name_box">업체 주소: ${shopList[0].shopaddr }</div>                                
                            <div class="store_name_box">업체 연락처: ${shopList[0].shoppn }</div>                                
                ...
                <div class="title_font">업체 등록 현황</div>
                <div>
                ...
                <div class="title_font">구직자 신청 현황</div>
                <div>
                    <div>
                    ...
                    <div class="divTable minimalistBlack">
                        ...
                        <div class="title_font">출근 현황</div>
                <div>
                    <div class="divTable minimalistBlack">
                        <div class="divTableHeading">
                        <div class="divTableRow">
                ...
                <div class="title_font">구직자 차단 내역</div>
                <div>
                    <div class="divTable minimalistBlack">
                        <div class="divTableHeading">
                        <div class="divTableRow">
